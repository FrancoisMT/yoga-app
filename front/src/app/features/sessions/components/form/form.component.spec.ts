...
describe('FormComponent', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('should initialize form when URL includes "update"', () => {
      ...
      const paramMapSpy = jest.spyOn(component.route.snapshot.paramMap, 'get').mockReturnValueOnce('123');
  ...
  describe('submit', () => {
    ...
    it('should call create method when onUpdate is false', () => {
      ...
      const createSpy = jest.spyOn(sessionApiService, 'create').mockReturnValue(of({} as any));
    ...
    it('should call update method when onUpdate is true', () => {
      ...
      // Mocker sessionApiService.create pour retourner un observable immédiat
      const updateSpy = jest.spyOn(sessionApiService, 'update').mockReturnValue(of({} as any));
      const exitPageSpy = jest.spyOn(component as any, 'exitPage');
