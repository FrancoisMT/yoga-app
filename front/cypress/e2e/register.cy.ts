...
describe('register spec', () => {
    ...
    it('should register, log in, verify user account details and delete it', () => {
        ...
        cy.get('.m3 mat-card-content p').contains(`Name: ${newUser.firstName} ${newUser.lastName.toUpperCase()}`).should('exist');
        cy.get('.m3 mat-card-content p').contains(`Email: ${newUser.email}`).should('exist');
